...
class CityStatisticsTest(unittest.TestCase):
    ...
    def test_empty_city(self):
        ...
        self.assertEquals(values['polyline_waypoints_count'], 0)
        self.assertEquals(values['polyline_intersections_count'], 0)
        self.assertEquals(values['average_polyline_intersections'], 0)
        self.assertEquals(values['average_polyline_waypoints'], 0)
        self.assertEquals(values['lines_and_arcs_waypoints_count'], 0)
        self.assertEquals(values['lines_and_arcs_intersections_count'], 0)
        self.assertEquals(values['average_lines_and_arcs_intersections'], 0)
        self.assertEquals(values['average_lines_and_arcs_waypoints'], 0)
    ...
    def test_sample_city(self):
        ...
        self.assertEquals(values['average_lines_and_arcs_intersections'], 4.0 / 3.0)
        self.assertEquals(values['average_lines_and_arcs_waypoints'], 14.0 / 3.0)
